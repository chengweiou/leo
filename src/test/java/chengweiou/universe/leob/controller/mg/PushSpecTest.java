...
public class PushSpecTest {
	...
	public void findById() throws Exception {
		String result = mvc.perform(MockMvcRequestBuilders.get("/mg/pushSpec/key")
	...
	public void count() throws Exception {
		String result = mvc.perform(MockMvcRequestBuilders.get("/mg/pushSpec/count")
			.header("loginAccount", GsonUtil.create().toJson(loginAccount))
			.param("person.id", "1")
		).andReturn().getResponse().getContentAsString();
	...
	public void find() throws Exception {
		String result = mvc.perform(MockMvcRequestBuilders.get("/mg/pushSpec")
				.header("loginAccount", GsonUtil.create().toJson(loginAccount))
				.param("person.id", "1")
		).andReturn().getResponse().getContentAsString();
